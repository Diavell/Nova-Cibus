...
public class Urun3 extends AppCompatActivity {
    ...
    int imageList[] = {R.drawable.kuskonmaz2 , R.drawable.kuskonmaz3 , R.drawable.kuskonmaz4 , R.drawable.kuskonmaz};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                imageSwitcher.setInAnimation(Urun3.this,
                        R.anim.from_right);
                imageSwitcher.setOutAnimation(Urun3.this,
                        R.anim.to_left);
                --currentIndex;
                if (currentIndex < 0)
        ...
        sepet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String urunadi = "Kuşkonmaz";
                String urunfiyati = "48.99 TL";

                Veritabani vt = new Veritabani(Urun3.this);
                vt.VeriEkle(urunadi,urunfiyati);

                Toast.makeText(Urun3.this, "Ürün sepetinize eklendi", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
